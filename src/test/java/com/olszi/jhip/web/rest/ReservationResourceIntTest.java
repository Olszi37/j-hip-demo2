...
import static com.olszi.jhip.web.rest.TestUtil.sameInstant;
...
public class ReservationResourceIntTest {
    ...
    public void createReservation() throws Exception {
        ...
        assertThat(testReservation.getDate_from()).isEqualTo(DEFAULT_DATE_FROM);
        assertThat(testReservation.getDate_to()).isEqualTo(DEFAULT_DATE_TO);
    }
    ...
    public void getAllReservations() throws Exception {
        ...
        restReservationMockMvc.perform(get("/api/reservations?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].date_from").value(hasItem(sameInstant(DEFAULT_DATE_FROM))))
            .andExpect(jsonPath("$.[*].date_to").value(hasItem(sameInstant(DEFAULT_DATE_TO))));
    }
    ...
    public void getReservation() throws Exception {
        ...
        restReservationMockMvc.perform(get("/api/reservations/{id}", reservation.getId()))
            ...
            .andExpect(jsonPath("$.date_from").value(sameInstant(DEFAULT_DATE_FROM)))
            .andExpect(jsonPath("$.date_to").value(sameInstant(DEFAULT_DATE_TO)));
    }
    ...
    public void updateReservation() throws Exception {
        ...
        Reservation testReservation = reservationList.get(reservationList.size() - 1);
        assertThat(testReservation.getDate_from()).isEqualTo(UPDATED_DATE_FROM);
        assertThat(testReservation.getDate_to()).isEqualTo(UPDATED_DATE_TO);
    }
